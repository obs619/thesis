...
public class ChatMessage implements Serializable {
	...
	private ChatMessage(String message, String userName, MessageOwner owner, String messageType) {
		mMessage = message;
		mUserName = userName;
		mOwner = owner;
	 ...
	 */
	public static ChatMessage obtain(String message, String userName, MessageOwner owner, String messageType) {
		return new ChatMessage(message, userName, owner, messageType);
	}
	...
	public static ChatMessage obtain(ChatMessage chatMessage) {
		return new ChatMessage(chatMessage.mMessage, chatMessage.mUserName, chatMessage.mOwner, chatMessage.mMessageType);
	}
